...
con <- connect_to_peekbank(dbname = "peekbank_dev") # pull from dev until prod brought up to date
...
trial_types <-  peekbankr::get_trial_types(connection=con) %>% collect()
#load language codes
iso_codes <- read_csv("iso_language_codes.csv")
#trial_types <-  peekbankr::get_trial_types()
